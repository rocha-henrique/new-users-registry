...
const createUser = async (fullName, email, phoneNumber, cellPhoneNumber) => {
  const newUser = await User.create({ fullName, email, phoneNumber, cellPhoneNumber });
...
const updateUser = async (id, fullName, email, phoneNumber, cellPhoneNumber) => {
  const [updatedUser] = await User.update(
    { fullName, email, phoneNumber, cellPhoneNumber },
    { where: { id } },
  );
